  ...
  return <DialogContent className="sm:max-w-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 pt-4">
        <div className="space-y-2">
          ...
          <Input id="salon-name" value={name} onChange={e => setName(e.target.value)} placeholder="Enter salon name" required />
        </div>
        
        <div className="space-y-2">
          <Label htmlFor="salon-description">Description</Label>
          <Textarea id="salon-description" value={description} onChange={e => setDescription(e.target.value)} placeholder="Describe your salon" rows={3} />
        </div>
        
        <div className="space-y-2">
          <Label htmlFor="salon-location">Address</Label>
          <Input id="salon-location" value={location} onChange={e => setLocation(e.target.value)} placeholder="Salon address" />
        </div>
        
        <div className="space-y-2">
          <Label htmlFor="salon-phone">Phone Number (Customers will message this number for bookings)</Label>
          <Input id="salon-phone" value={phone} onChange={e => setPhone(e.target.value)} placeholder="Salon phone number" />
        </div>
